        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <div class="form-outline mb-4">
                ...
                <input type="text" id="form3Example3" class="form-control form-control-lg"
                    placeholder="Nhập địa chỉ email" name="ten_dang_nhap" value="<?php echo $email;?>"/>
            </div>
            ...
            <div class="form-outline mb-3">
                ...
                placeholder="Nhập mật khẩu" name="mat_khau" value=""/>
            </div>
            <div class="form-outline mb-3">
                <label class="form-label" for="form3Example4">Nhập lại mật khẩu</label>
                <input type="password" id="form3Example4" class="form-control form-control-lg"
                placeholder="Nhập lại mật khẩu" name="nhap_lai_mat_khau" value=""/>
            </div>
            <div class="form-outline mb-3">
